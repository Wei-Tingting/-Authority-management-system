...
public class ListController {
    ...
    public void selectUser(HttpServletRequest request, HttpServletResponse response,
                           ...
                           @RequestParam(value = "sno",required = false) String sno) throws ServletException, IOException {
    ...
    */
    ...
    public PageInfo<Student> SearchStudent(HttpServletRequest request, @RequestParam(value = "value",required = false) String value,
        ...
        List<Student> students = studentService.queryStudentByNameAndSno(page,8,value);
